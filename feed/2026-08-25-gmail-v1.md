...
api: gmail.v1
service: Gmail
title: "Gmail API: Strict Parameter Validation & CSE Immutability"
impact: high
breaking: true
tags: ["breaking-change", "security", "cse"]
interesting_score: 9
---
...
The Gmail API has updated its discovery document to enforce strict requirement checks on core parameters and transition several Client-Side Encryption (CSE) fields to read-only status.
